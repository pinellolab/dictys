...
parser = argparse.ArgumentParser(
	...
	usage='samtools view whole.bam | python3 split.py [-h] [--output_unknown OUTPUT_UNKNOWN] [--section SECTION] [--buffer_size BUFFER_SIZE] [--ref_expression REF_EXPRESSION] [--namemap NAMEMAP] output_folder')
...
parser.add_argument('--namemap',type=str,default=None,help='Cell name map between RNA (actual cell name) and ATAC cells in format file_path,RNA_column_ID,ATAC_column_ID. File should be in tsv format. If unset, will regard RNA and ATAC cell names identical.')
